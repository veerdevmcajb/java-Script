...
// Line 2 (Explained) => z = NaN bcoz In above line we can not access the value of the 'this' keyword because the AF dont has its own 'this' thus uses the this of the parent function. But here there is no parent function rather it is itself defined as the method of the obj5. Thus referes to global function which is under the Window object. Therefore in unstrict mode it may refer to Window objects variables.
