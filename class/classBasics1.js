...
let employee1 = new EmployeeDetails("Abhishek", "156966", "8485866580");
...
// !----------------- Using default values in constructor method ------------
...
// ! ------------------------ instanceof operator ---------------------
// The instanceof is the operator which checks whether the given object is the instance of the particular class
// ? Syntax - object instanceof className 
// ? It will return a boolean value after comparision.

console.log(user1 instanceof user);

// ! ----------------------- Accessing the class name inside the class itself -------------
...
class User {
    constructor(name, mybestFriend = "BFF") {
        this.name = name;
        this.mybestFriend = mybestFriend;
    }
...
console.log(user1.myFriend);

}
// So, we just write " = " in the declaration, and that’s it.
// The important difference of class fields is that they are set on individual objects, not User.prototype:

//* vimp learning here is that the class fields and the class properties that are set using the constructor function are set on the new instances created using the class 
// and not the user.prototype. But the methods or functions written in the classs are set on the prototype and not on the new objects created using the classes.
