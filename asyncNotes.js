...
When any js code is run the Global Execution Context is created and whole programme is run line by line  under this Global Execution Context. When any line of code is executed it will enter the stack as the GEC (Global Execution Context) item. This happens frequently untill all the lines are executed and the JS code is traversed completely. After executing each line, the line is popped out of the Call Stack and new line enters as the GEC (Global Execution Context).
